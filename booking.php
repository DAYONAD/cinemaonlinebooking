            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">March 12,2023</option>
                        <option value="13-3">March 13,2023</option>
                        <option value="14-3">March 14,2023</option>
                        <option value="15-3">March 15,2023</option>
                        <option value="16-3">March 16,2023</option>
                    </select>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        window.open("/DayoTasued/foo.php");
                        </script>'; 
